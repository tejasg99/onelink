...
export function UsernameForm({ currentUsername }: UsernameFormProps) {
  ...
  const hasChanges = watchedUsername.toLowerCase() !== currentUsername?.toLowerCase()
  const profileUrl = currentUsername ? `${getBaseUrl()}/${currentUsername}` : null
    ...
    <div className="space-y-6">
      ...
      {currentUsername && (
        <div className="rounded-lg bg-muted p-4">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <CopyButton text={profileUrl!} size="sm" variant="ghost" className="cursor-pointer"/>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button
          ...
          disabled={isLoading || !hasChanges || isAvailable === false || !watchedUsername}
        >
