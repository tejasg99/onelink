...
import { editCodeSchema, type EditCodeFormData } from "@/lib/validations/onelink"
import { editCodeOneLink } from "@/lib/actions/onelink"
...
export function EditCodeForm({ onelink, content }: EditCodeFormProps) {
    const router = useRouter()
    const [isLoading, setIsLoading] = useState(false)

    const form = useForm<EditCodeFormData>({
    ...
    const onSubmit = async (data: EditCodeFormData) => {
        setIsLoading(true)
        try {
            const result = await editCodeOneLink(data)
